...
class CompleteTradingSystem:
    ...
    def get_historical_data(self, symbol, interval, start_str, end_str=None, limit=300):
        """获取历史K线数据"""
...
if __name__ == '__main__':
    try:
        ...
        start_date = '2025-08-01 00:00:00'  # 开始日期
        end_date = '2025-08-01 19:59:00'  # 结束日期（None表示到现在）
        # 解析并标记为 UTC 时区
        #start_date = datetime.strptime(start_date + "+00:00", "%Y-%m-%d %H:%M:%S%z")
        #end_date = datetime.strptime(end_date + "+00:00", "%Y-%m-%d %H:%M:%S%z")
